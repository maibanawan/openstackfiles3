...
export BLUE_sub=$(curl -s http://127.0.0.1:9696/v2.0/subnets -X POST -H "Content-Type: application/json" -H "Accept: application/json" -H "X-Auth-Token:$OS_TOKEN" -d '{"subnet":{"name":"Subamp","cidr":"10.0.0.0/24","ip_version":4,"network_name":"BLUE"}}' | python -m json.tool)
echo $1
