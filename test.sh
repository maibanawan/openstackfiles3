...
echo $router
export xx=$(curl -k -X PUT http://127.0.0.1:9696/v2.0/subnets/$psubid -H "Content-Type: application/json" -H "X-Auth-Token: $OS_TOKEN" -d '{"subnet":{"host_routes":[{"destination":"10.0.0.0/24","nexthop":"172.24.4.9"}]}}')
