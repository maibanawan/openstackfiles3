...
export x=$(curl -k -X PUT http://127.0.0.1:9696/v2.0/subnets/b5f13dd8-b273-46c0-9472-e31feb444b22 -H "X-Auth-Token: $OS_TOKEN" -H "Content-Type: application/json" -d cat my.json | pyhton -m json.tool
